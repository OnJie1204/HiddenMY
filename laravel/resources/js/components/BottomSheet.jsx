...
function BottomSheet({ gem, onClose }) {
    if (!gem) return null;
    ...
    function openWaze() {
        const url = `https://www.waze.com/ul?ll=${gem.latitude},${gem.longitude}&navigate=yes`;
        window.open(url, "_blank");
    }
    ...
    return (
        <div className="bottom-sheet">
            ...
            <button onClick={onClose} className="bottom-sheet-close" aria-label="Close">✕</button>
            ...
            <div className="action-buttons">
                <button className="map-action-button" onClick={openGoogleMaps}>
                    <img src={googleMapsIcon} alt="Google Maps" />
                </button>
                <button className="map-action-button" onClick={openWaze}>
