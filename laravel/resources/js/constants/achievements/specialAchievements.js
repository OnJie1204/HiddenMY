...
export const SPECIAL_ACHIEVEMENT_METADATA = Object.freeze({
    "first-footprint": {
        title: "First Footprint",
        artwork: firstFootprintArtwork,
    },
    "gem-hunter": {
        title: "Gem Hunter",
        artwork: gemHunterArtwork,
    },
    "halfway-there": {
        title: "Halfway There",
        artwork: halfwayThereArtwork,
    },
    "voice-of-the-community": {
        title: "Voice of the Community",
        artwork: voiceOfTheCommunityArtwork,
    },
    "west-malaysia-explorer": {
        title: "West Malaysia Explorer",
        artwork: westMalaysiaExplorerArtwork,
    },
    "east-malaysia-explorer": {
        title: "East Malaysia Explorer",
        artwork: eastMalaysiaExplorerArtwork,
    },
    "off-the-beaten-path": {
        title: "Off the Beaten Path",
        artwork: offTheBeatenPathArtwork,
    },
    "hiddenmy-master": {
        title: "HiddenMY Master",
        artwork: hiddenmyMasterArtwork,
    },
});
