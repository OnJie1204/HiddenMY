...
const verifyModalSource = readFileSync(
    new URL("../../resources/js/components/community/VerifyReportModal.jsx", import.meta.url),
    "utf8",
);
const reportModalSource = readFileSync(
    new URL("../../resources/js/components/community/ReportModal.jsx", import.meta.url),
    "utf8",
);
const reportsApiSource = readFileSync(
    new URL("../../resources/js/features/community/reportsApi.js", import.meta.url),
    "utf8",
);
