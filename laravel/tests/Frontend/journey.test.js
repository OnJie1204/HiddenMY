...
const journeyMapSource = readFileSync(
    new URL("../../resources/js/components/achievements/HiddenGemJourneyMap.jsx", import.meta.url),
    "utf8",
);
const clusterIconSource = readFileSync(
    new URL("../../resources/js/components/hidden-gems/GemClusterIcon.jsx", import.meta.url),
    "utf8",
);
